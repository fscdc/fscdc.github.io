...
* Time-LLM: Time Series Forecasting by Reprogramming Large Language Models. [\[Paper\]](https://arxiv.org/abs/2310.01728) [\[Note\]](https://fscdc.github.io/blog/2024/time-llm/)

* TEST: Text Prototype Aligned Embedding to Activate LLM's Ability for Time Series. [\[Paper\]](https://arxiv.org/abs/2308.08241) [\[Note\]](https://fscdc.github.io/blog/2024/test/)

* PromptCast: A New Prompt-based Learning Paradigm for Time Series Forecasting Hao, in *arXiv* 2022. [\[Paper\]](https://arxiv.org/abs/2210.08964) [\[Note\]](https://fscdc.github.io/blog/2024/promptcast/)

* One Fits All: Power General Time Series Analysis by Pretrained LM, in *arXiv* 2023. [\[Paper\]](https://arxiv.org/abs/2302.11939) [\[Note\]](https://fscdc.github.io/blog/2024/onefitsall/)


* Temporal Data Meets LLM -- Explainable Financial Time Series Forecasting, in *arXiv* 2023. [\[Paper\]](https://arxiv.org/abs/2306.11025) 


* LLM4TS: Two-Stage Fine-Tuning for Time-Series Forecasting with Pre-Trained LLMs. [\[Paper\]](https://arxiv.org/abs/2308.08469) [\[Note\]](https://fscdc.github.io/blog/2024/llm4ts/)
...
* TEMPO: Prompt-based Generative Pre-trained Transformer for Time Series Forecasting. [\[Paper\]](https://arxiv.org/abs/2310.04948) [\[Note\]](https://fscdc.github.io/blog/2024/tempo/)
